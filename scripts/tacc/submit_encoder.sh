...
#     STAGES=spacetime-esk bash scripts/tacc/submit_encoder.sh
#     STAGES=desk TIME=04:00:00 bash scripts/tacc/submit_encoder.sh
#     bash scripts/tacc/submit_encoder.sh                     # all four (spacetime-esk desk cube validate)
...
echo "submitted 20_encoder ($QUEUE, $TIME, STAGES='${STAGES:-spacetime-esk desk cube validate}'): $jid"
